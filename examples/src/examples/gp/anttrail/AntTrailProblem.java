...
public class AntTrailProblem
  ...
  public AntTrailProblem(GPConfiguration config, String a_filename)
    ...
    //all of this code is specifying something that happens when this event is triggered
    config.getEventManager().addEventListener(GeneticEvent.
      ...
      public void geneticEventFired(GeneticEvent a_firedEvent) {
        ...
        if (evno % 100 == 0) { //every 100th generations...
          double bestFitness = genotype.getFittestProgram().
              getFitnessValue(); //get the fittest... ah, and print it to the console.
    ...
    }); //end definition of the callback function
  ...
  public GPGenotype create()
    ...
    //the nodesets appear to comprise the sets of functions and terminals
    //each function or terminal appears to be implemented as a CommandGene
