...
public class IECFitnessFunction extends FitnessFunction {
	...
	public void adjustWeights(double adjust_actual_fitness_weight){
		...
		System.out.println("PRE-Adjusted actual fitness weight: "+actual_fitness_weight);
		System.out.println("PRE-Adjusted expected fitness weight: "+expected_fitness_weight);
		...
		System.out.println("Adjusted actual fitness weight: "+actual_fitness_weight);
		System.out.println("Adjusted expected fitness weight: "+expected_fitness_weight);
	}
